...
// declare global variables needed for your snake (as `extern`)! (part 1A)
// extern int snakeHeadLocIndex;
// extern enum input_key snakeDir;
...
typedef struct snake {
    ...
    // Pointers to other snake nodes
    struct snake* prev;
    struct snake* next;
    // Where the snake is located currently
    int snakeHeadIndex;
    // What direction the snake is traveling in
    enum input_key snakeDir;
} snake_t;
